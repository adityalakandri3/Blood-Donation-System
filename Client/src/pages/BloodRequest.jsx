...
import bannerImage from '../assets/requested.jpg'; // Make sure this path is correct
    ...
    <>
      ...
      >
        <Paper
          elevation={6}
          sx={{
            backgroundColor: 'rgba(45, 47, 56, 0.85)',
            padding: 4,
            borderRadius: 3,
            maxWidth: 700,
            width: '100%',
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  variant="filled"
                  fullWidth
                  InputProps={{ sx: { backgroundColor: '#4A4F5A', color: 'white' } }}
